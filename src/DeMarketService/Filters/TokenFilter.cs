    ...
    public class TokenFilter : IAsyncAuthorizationFilter
    {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            ...
            if (token == null)
            {
                ...
                if (!path.Equals("/api/user/login", StringComparison.OrdinalIgnoreCase) && !path.Equals("/api/notice/sendemail", StringComparison.OrdinalIgnoreCase) && !path.Equals("/api/order/list", StringComparison.OrdinalIgnoreCase) && !path.Equals("/api/notice/cooperate", StringComparison.OrdinalIgnoreCase) && !path.Equals("/api/orderauction/list", StringComparison.OrdinalIgnoreCase) && !path.Equals("/api/orderauction/switch_like", StringComparison.OrdinalIgnoreCase) && !path.Equals("/api/order/switch_like", StringComparison.OrdinalIgnoreCase))
                {
